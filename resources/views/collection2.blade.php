            ...
            <div class="ps-product__columns">
                ...
                <div class="ps-product__column">
                    ...
                    <div class="ps-shoe__thumbnail">
                        ...
                        <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="{{ $item['image_source'] }}" alt=""><a class="ps-shoe__overlay" href="{{ $item['slug'] }}.html"></a>
                    </div>
                    <div class="ps-shoe__content">
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#">{{ $item['title'] }}</a>
                        <p class="ps-shoe__categories"><a href="#">Men shoes</a>,<a href="#"> Nike</a>,<a href="#"> Jordan</a></p><span class="ps-shoe__price">
                            <del>£220</del> $ {{ $item['price'] }}</span>
                        </div>
        ...
        <aside class="ps-widget--sidebar ps-widget--category">
          ...
          <div class="ps-widget__content">
            <ul class="ps-list--checked">
                ...
                <li class=""><a href="{{url($item['slug'])}}.html">{{strtoupper($item['title'])}}</a></li>
                @endforeach
            </ul>
          </div>
        </aside>
